package edu.courseflow.enrollment.config;
 ...
 * (or, with the default attempts, the record is eventually dropped and the event is lost).
 *
 * <p>Behaviour:
 * <ul>
 *   <li>A failing record is retried with exponential backoff up to a bounded elapsed time.</li>
...
public class KafkaErrorHandlingConfig {
    ...
    /** Dedicated producer for dead-letter records (this service is otherwise outbox-driven for output). */
    @Bean
